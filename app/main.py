...
def build_system_prompt(user: dict | None, ctx: dict) -> str:
    ...
    return (
        ...
        "If the search result contains a 'location_note' field, mention it "
        "briefly (e.g. 'no experiences in X — here's what we have') and "
        "still present the full list so the user can pick one.\n\n"
        "Roles are distinct:\n"
