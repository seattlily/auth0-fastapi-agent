            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "return_date":  {"type": "string", "description": "Return date YYYY-MM-DD. Omit for one-way trips."},
                        "cost":         {"type": "number", "description": "Total cost in the organization's currency."},
                        "currency":     {"type": "string", "description": "ISO currency code. Default USD."},
                    },
                    "required": ["customer_id", "type", "origin", "destination", "depart_date", "cost"],
                },
            },
        },
    },
        ...
        "schema": {
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "required": ["type", "origin", "destination", "depart_date", "cost"],
                },
            },
        },
    },
